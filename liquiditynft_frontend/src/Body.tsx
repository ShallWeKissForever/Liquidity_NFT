...
function CoinSelector() {
  ...
  return (
    <>
      ...
      <div style={{ position:'relative', left:'275px', bottom:'45px' }}>
...
// todo
function CreatePool() {
  return <div>这里是限额功能</div>;
}

// todo
function AddLiquidity() {
  return <div>这里是发送功能</div>;
}

// todo
function RemoveLiquidity() {
  return <div>这里是购买功能</div>;
}
          ...
          <div style={{ marginBottom: '10px' }}>
            ...
            <Button 
              ...
              style={{
                ...
                border:'0px',
                borderRadius:'17px',
                backgroundColor: activeFeature === 'swap' ? 'blue' : 'white',
            ...
            style={{
              ...
              border:'0px',
              borderRadius:'17px',
              backgroundColor: activeFeature === 'createPool' ? 'blue' : 'white',
            ...
            style={{
              ...
              border:'0px',
              borderRadius:'17px',
              backgroundColor: activeFeature === 'addLiquidity' ? 'blue' : 'white',
            ...
            style={{
              ...
              border:'0px',
              borderRadius:'17px',
              backgroundColor: activeFeature === 'removeLiquidity' ? 'blue' : 'white',
